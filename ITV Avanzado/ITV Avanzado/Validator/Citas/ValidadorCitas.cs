...
namespace ITV_Avanzado.Validator.Citas;

    public class ValidadorCitas : IValidator<Cita> {
        public Result<Cita, DomainError> Validar(Cita entidad) {
            ...
            return Result.Success<Cita, DomainError>(entidad);
        }
