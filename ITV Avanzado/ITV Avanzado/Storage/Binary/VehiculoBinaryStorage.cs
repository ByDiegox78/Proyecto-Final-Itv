...
public class VehiculoBinaryStorage : IVehiculoBinaryStorage {
    
    private readonly ILogger _logger = Log.ForContext<VehiculoBinaryStorage>();

    public VehiculoBinaryStorage() {
    ...
    public Result<IEnumerable<Vehiculo>, DomainError> Cargar(string path) {
        ...
        try {
            ...
            return Result.Success<IEnumerable<Vehiculo>, DomainError>(list);
        } catch (Exception e) {
