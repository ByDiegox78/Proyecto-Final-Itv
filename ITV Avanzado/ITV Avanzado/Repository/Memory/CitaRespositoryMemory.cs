    ...
    public class CitaRespositoryMemory : ICitaRepository {
        private readonly ILogger _logger = Log.ForContext<CitaRespositoryMemory>();
        private readonly Dictionary<string, int> _matricula = new();
        private readonly Dictionary<int, Cita> _porId = new();
        private int _idCounter;

        
        public CitaRespositoryMemory( bool dropData, bool seedData) {
            if (dropData) {
