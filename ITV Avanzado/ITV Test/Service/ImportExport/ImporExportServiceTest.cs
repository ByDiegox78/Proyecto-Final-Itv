...
public class ImporExportServiceTest {
    ...
    public class CasosPositivos : ImporExportServiceTest {
        ...
        public void Exportar_ConCitas_DevuelveContador() {
            var citas = new List<Vehiculo> {
                new Vehiculo { Matricula = "1234VCF", Marca = "Alfa" },
                new Vehiculo { Matricula = "1234VCG", Marca = "Renault" },
                new Vehiculo { Matricula = "1234VCH", Marca = "Fiat" }
            };
        ...
        public void Import_ConArchivo_DevuelveCitas() {
            ...
            _storageMock.Setup(s => s.Cargar(path))
                .Returns(Result.Success<IEnumerable<Vehiculo>, DomainError>(citas));
        ...
        public void Exportar_DeberiaLLamarExportarDatosConRutaVacia() {
            ...
            _storageMock.Verify(s => s.Salvar(It.IsAny<IEnumerable<Vehiculo>>(), string.Empty), Times.Once);
    ...
    public class CasosNegativos : ImporExportServiceTest {
        ...
        public void ImportarDatos_ConError_DeberiaRetornarError() {
            ...
            _storageMock.Setup(s => s.Cargar(path))
                .Returns(Result.Failure<IEnumerable<Vehiculo>, DomainError>(
                    VehiculoErrors.StorageError("File not found")));
