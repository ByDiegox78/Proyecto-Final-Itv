...
namespace ITV_Test.Repository.Json;

[TestFixture]
public class CitaJsonRepositoryTest {
    [TestFixture]
    public class CasosPositivos {
        [SetUp]
        public void SetUp() {
            _temp = Path.GetTempFileName();
            _repository = new CitaJsonRepository(_temp, true, false);
        ...
        private CitaJsonRepository _repository = null!;
        
        [Test]
        public void Constructor_ConSeedData_CargaDatosIniciales() {
            
            var repoConSemilla = new CitaJsonRepository(_temp, true, true); 
        ...
        public void Constructor_DropDataYFileExiste_EliminaCorrectamente() {
            ...
            var repoConSemilla = new CitaJsonRepository(tempFile, true, true); 
