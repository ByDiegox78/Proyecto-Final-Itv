...
public class VehiculoBinaryRepositoryTest {
    ...
    public class CasosPositios {
        ...
        private VehiculoBinaryRepository _repository = null!;
        
        [Test]
        public void Load_DebeRecuperarDatos_CuandoSeInstanciaNuevoRepositorio() {
            // Arrange
            var vehiculo = new Vehiculo { Matricula = "1234ABC", Marca = "Prueba", DniPropietario = "123" };
            _repository.Create(vehiculo);
            
            var nuevoRepo = new VehiculoBinaryRepository(_temp, false, false);
