...
[TestFixture]
public class CitasRepositoryMemoryTest {
    [TestFixture]
    public class CasosPositivos {
        [SetUp]
        public void SetUp() {
            _repository = new CitaRespositoryMemory(true, false);
        }

        private CitaRespositoryMemory _repository = null!;
        
        
        [Test]
        public void Constructor_ConSeedData_CargaDatosIniciales() {
            
            var repoConSemilla = new CitaRespositoryMemory( true, true); 
    ...
    [TestFixture]
        public class CasosNegativos {
            ...
            public void  Update_PropietarioConLimiteDeVehiculoSuperado_DebeDevolverError() {
                var v1 = new Cita {
                    Matricula = "4567BCH",
                    Marca = "Fiat", Cilindrada = 1200, TipoMotor = Motor.Gasolina, DniPropietario = "41234571X", FechaInspeccion = new DateTime(2024, 01, 17),
                    IsDeleted = false, CreatedAt = new DateTime(2024, 01, 17), UpdatedAt = new DateTime(2024, 01, 17)
                };
                var v2 = new Cita {
                    Matricula = "1234BCD", Marca = "Seat Ibiza", Cilindrada = 1200, TipoMotor = Motor.Gasolina, DniPropietario = "41234571X", FechaInspeccion = new DateTime(2024, 01, 17),
                    IsDeleted = false, CreatedAt = new DateTime(2024, 01, 17), UpdatedAt = new DateTime(2024, 01, 17)
                };
                var v3 = new Cita {
                    Matricula = "2345BCF", Marca = "Fiat", Cilindrada = 1200, TipoMotor = Motor.Gasolina, DniPropietario = "41234571X",FechaInspeccion = new DateTime(2024, 01, 17),
                    IsDeleted = false, CreatedAt = new DateTime(2024, 01, 17), UpdatedAt = new DateTime(2024, 01, 17)
                };
                var v4 = new Cita {
                    Matricula = "3456BDG",
                ...
                var actu = new Cita {
                    DniPropietario = "41234571X", FechaInspeccion = new DateTime(2024, 01, 17),
                };
            ...
            public void Update_VehiculoConInspeccionExistente_DevuelveError() {
                ...
                res.IsFailure.Should().BeTrue();
                res.Error.Should().BeOfType<CitaError.MatriculaInspeccionDuplicada>();
                (res.Error as CitaError.MatriculaInspeccionDuplicada)?.matricula.Should().Be("4567BCH");
            }
        }
}