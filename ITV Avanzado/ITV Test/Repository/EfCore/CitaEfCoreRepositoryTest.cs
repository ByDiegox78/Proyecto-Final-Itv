...
public class CitaEfCoreRepositoryTest {
    ...
    public class CasosPositivos {
        ...
        public void SetUp() {
            ...
            _repository = new CitaEfCoreRepository(_context, dropData: true, seedData: false);
        }
        ...
        public void Constructor_SeedDataTrueYTablaVacia_InsertaDatos() {
            var repo = new CitaEfCoreRepository(_context, dropData: true, seedData: true);

            _context.Citas.Count().Should().BeGreaterThan(0);
        }
        ...
        public void Delete_ConBoradoFisico_EliminaCorrectamente() {
            _repository = new CitaEfCoreRepository(_context, true, false);
            var vehiculo = new Cita {
                Matricula = "1234BCD", Marca = "Seat Ibiza", Cilindrada = 1200, TipoMotor = Motor.Gasolina,
